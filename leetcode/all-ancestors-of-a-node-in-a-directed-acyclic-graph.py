...
class Solution:
    def getAncestors(self, n: int, edges: List[List[int]]) -> List[List[int]]:
        ...
        # def dfs(u, currentAncestors):
        #     for ca in currentAncestors:
        #         ancestors[u].add(ca)

        #     for v in adj[u]:
        #         dfs(v, currentAncestors + [u])
